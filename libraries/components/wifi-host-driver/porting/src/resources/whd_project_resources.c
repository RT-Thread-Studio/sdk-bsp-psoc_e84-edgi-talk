...
#if defined(WHD_RESOURCES_IN_MEMORY) && defined(WHD_USING_CHIP_CYW55500)

#if defined(__GNUC__)
__asm__(
    ".section .rodata.whd_firmware,\"a\",%progbits\n"
    ".balign 4\n"
    ".global wifi_firmware_image_data\n"
    ".weak wifi_firmware_image_data\n"
    "wifi_firmware_image_data:\n"
    ".incbin \"../resources/55500A1.trxcse\"\n"
    ".balign 4\n"
    ".global wifi_firmware_image_data_end\n"
    ".weak wifi_firmware_image_data_end\n"
    "wifi_firmware_image_data_end:\n"
    ".section .rodata.whd_clm,\"a\",%progbits\n"
    ".balign 4\n"
    ".global wifi_firmware_clm_blob_data\n"
    ".weak wifi_firmware_clm_blob_data\n"
    "wifi_firmware_clm_blob_data:\n"
    ".incbin \"../resources/55500A1.clm_blob\"\n"
    ".balign 4\n"
    ".global wifi_firmware_clm_blob_data_end\n"
    ".weak wifi_firmware_clm_blob_data_end\n"
...
const resource_hnd_t wifi_firmware_image =
{
    RESOURCE_IN_MEMORY,
    233524,
    {.mem = {(const char *)wifi_firmware_image_data}}
};
...
const resource_hnd_t wifi_firmware_clm_blob =
{
    RESOURCE_IN_MEMORY,
    1008,
    {.mem = {(const char *)wifi_firmware_clm_blob_data}}
};
#endif

__attribute__((weak))
const char wifi_nvram_image[6742] =
    ...
    "txidxcap5g=10" "\x00"
    "txidxcap6g=10" "\x00"
    "pa2ga0=-100,6472,-601" "\x00"
    "pa2gccka0=0,8015,-676" "\x00"
    "pa5ga0=-94,6977,-662,-88,6929,-654,-135,6647,-702,-110,6826,-675" "\x00"
    "pa6ga0=-157,6377,-693,-156,6419,-702,-145,6625,-717,-162,6268,-698" "\x00"
    "maxp2ga0=86" "\x00"
    ...
    "swdiv_snrlim=290 #Only enable sw_div if the snr on present antenna is less than 290/8=36.25" "\x00"
    "swdiv_thresh=2000 #No.of rxpkts threshold" "\x00"
    "swdiv_snrthresh=24 #Difference between antenna's snr is greater than 24/8=3dB, then shift the antennas" "\x00"
    "swdiv_timeon=10" "\x00"
    "swdiv_timeoff=1" "\x00"
    ...
    "swdiv_ap_dead_check=0 #Enable sending of null frames at a periodicity of 1 sec to check whether the present antenna is dead" "\x00"
    "swdiv_ap_div=0 #Enabling ap_diversity" "\x00";

__attribute__((weak))
const uint32_t wifi_nvram_image_size = sizeof(wifi_nvram_image);
